"""
Django settings for SheepFish_test project.
...
SECRET_KEY = "django-insecure-*+qjn@)urnaktl2%@#$5-t=#d70#*p(!6rypak7lhm%%a@$)v="
...
ROOT_URLCONF = "SheepFish_test.urls"
...
WSGI_APPLICATION = "SheepFish_test.wsgi.application"
